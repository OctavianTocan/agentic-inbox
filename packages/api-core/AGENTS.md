...
- When defining endpoints, schemas, or errors, prefer patterns from `repos/effect-smol` and [`agent-patterns/`](../../agent-patterns/) over guessing.
- Read [`repos/effect-smol/LLMS.md`](../../repos/effect-smol/LLMS.md) first, then `packages/effect/HTTPAPI.md` / Schema docs as needed.
- Index: [`agent-patterns/README.md`](../../agent-patterns/README.md) — especially `module-layout`, `effect-httpapi`, `effect-schema`.
