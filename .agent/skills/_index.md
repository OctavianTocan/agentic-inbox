...
Preserves reader intent in streaming AI chat transcripts and long threads.
Triggers: "streaming chat", "message scroller", "auto-scroll",
"jump to latest", "chat scroll", "long thread", "AI chat accessibility",
"message-scroller"
Constraints: never move the reader against intent; auto-follow only while the
reader is following; preserve position across layout shifts.

## cleanup-unused-project-surface
Audits unused backend code, frontend components, UI primitives, design assets,
styles, package exports, and repo-local skills before cleanup.
Triggers: "unused code", "dead code", "remove unused", "prune components",
"cleanup design system", "unused backend", "unused UI"
Constraints: propose removals with verifiable non-usage evidence before deleting;
do not remove uncertain dynamic/framework usage without approval.
