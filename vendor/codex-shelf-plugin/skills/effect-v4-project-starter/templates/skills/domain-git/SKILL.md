---
name: domain-git
description: "Use when committing, creating or updating pull requests, pushing branches, rebasing, resolving conflicts, or writing PR descriptions."
---
...
Format: `<type>(<scope>): <imperative summary>` (Conventional Commits) with optional body and references. Scopes map to the monorepo structure (e.g. `api`, `app`, `web`, `database`). Drop the scope when no single area applies.
