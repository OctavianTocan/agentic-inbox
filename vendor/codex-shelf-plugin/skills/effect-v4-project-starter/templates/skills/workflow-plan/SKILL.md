...
**When to grill.** If the domain has dense terminology, conflicting concept names, or unresolved invariants, interrogate the approved brainstorm against the project's docs before Phase 2 — sharpen terminology and capture any ADRs you'd otherwise re-litigate later.
