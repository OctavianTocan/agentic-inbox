...
const externalPrefixes = ['src/ai-ui/', 'src/design-system/'];
...
console.log(
  'Web typecheck passed for owned source; external template diagnostics are excluded: src/ai-ui, src/design-system.'
);
