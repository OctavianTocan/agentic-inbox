...
import "@/design-system/components/dotmatrix-loader.css";
import { useMemo } from "react";
import { useDotMatrixPhases, usePrefersReducedMotion, useCyclePhase } from "@/design-system/lib/dotmatrix-hooks";
...
function resolveDmxBoxOuterDim(
  options:
    | { boxSize?: number | undefined; minSize?: number | undefined }
    | null
    | undefined
