...
/** Vertical stack wrapper for a group of items. */
...
/** Item container variants (visual style and density). */
...
/** Item row with variant and size styling, renderable as a custom element. */
function Item({
  className,
  variant = "default",
  size = "default",
...
/** Item media slot variants (icon vs image presentation). */
...
/** Leading media slot for an item (icon or image). */
function ItemMedia({
  className,
  variant = "default",
  ...props
...
/** Primary content column of an item (title and description). */
...
/** Secondary description text of an item. */
...
/** Trailing actions slot of an item. */
...
/** Full-width header row spanning an item. */
...
/** Full-width footer row spanning an item. */
