...
import { XIcon } from "@/design-system/components/icons";
import { cn } from "../../lib/utils";
import { Button } from "./button";

/** Sheet root that controls open state for an edge-anchored dialog. */
function Sheet({ ...props }: SheetPrimitive.Root.Props) {
  return <SheetPrimitive.Root data-slot="sheet" {...props} />;
}

/** Element that opens its `Sheet` when activated. */
function SheetTrigger({ ...props }: SheetPrimitive.Trigger.Props) {
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...props} />;
}

/** Element that closes its `Sheet` when activated. */
...
/** Sliding panel anchored to the given `side`, with an optional close button. */
...
/** Heading region of a `SheetContent`. */
...
/** Footer region of a `SheetContent`, typically holding actions. */
...
/** Muted supporting text beneath a `SheetTitle`. */
