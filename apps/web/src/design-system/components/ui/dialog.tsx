  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        className={cn(
          "data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-md bg-card p-4 text-sm outline-none ring-1 ring-foreground/10 shadow-md duration-100 data-closed:animate-out data-open:animate-in sm:max-w-sm",
          className,
        )}
