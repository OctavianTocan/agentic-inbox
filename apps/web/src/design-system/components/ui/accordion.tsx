...
/** Accordion root: a vertical stack of independently collapsible sections. */
...
/** Clickable header that toggles its `AccordionItem` open or closed. */
...
/** Collapsible panel revealed when its `AccordionItem` is open. */
