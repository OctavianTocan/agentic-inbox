...
import { CheckIcon, ChevronRightIcon } from "@/design-system/components/icons";
import { cn } from "../../lib/utils";

/** Root that opens a menu on right-click of its trigger. */
function ContextMenu({ ...props }: ContextMenuPrimitive.Root.Props) {
  return <ContextMenuPrimitive.Root data-slot="context-menu" {...props} />;
}

/** Portals the context-menu content out of the DOM flow. */
...
/** Region whose right-click opens the context menu. */
...
/** Positioned, portalled popup that holds the menu items. */
...
/** Groups related menu items into a section. */
...
/** Non-interactive heading for a menu group; `inset` aligns it with item icons. */
...
/** Selectable menu row; `variant` toggles the destructive style. */
...
/** Item that opens a nested submenu, with a trailing chevron. */
...
/** Popup content for a submenu opened from a `ContextMenuSubTrigger`. */
...
/** Menu item with a toggleable check state. */
...
/** Single-choice menu item within a `ContextMenuRadioGroup`. */
...
/** Divider line between menu groups or items. */
...
/** Trailing keyboard-shortcut hint aligned to the end of a menu item. */
