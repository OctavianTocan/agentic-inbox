...
/** Grouped toggle buttons sharing variant, size, spacing, and orientation via context. */
...
/** Single toggle within a {@link ToggleGroup}, inheriting group styling unless overridden. */
